...
from ..model.model import Compound, ThermalConductivity, Viscosity, DielectricConstant, FlashPoint
...
class Paragraph(Text):
    ...
    def __init__(self, text, **kwargs):
        ...
        self.models = [ThermalConductivity, Viscosity, DielectricConstant, FlashPoint
